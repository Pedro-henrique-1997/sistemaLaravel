...
<div class="row">
            ...
            <div class="row">
                  ...
                  <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <select name="idfornecedor" id="idfornecedor" class="form-control" data-live-search="true">
            ...
            <div class="panel panel-primary">
                  <div class="panel-body">
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                              ...
                              <select name="pidproduto" id="pidproduto" class="form-control" data-live-search="true">
